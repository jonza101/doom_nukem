...
#    Updated: 2019/09/18 17:06:32 by zjeyne-l         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
all :
	gcc -g -Ofast $(SRC) -lm -lpthread -lmlx -framework OpenGL -framework AppKit -L ~/.brew/lib -lSDL2-2.0.0 -I ~/.brew/include -L ~/.brew/lib -lSDL2_mixer-2.0.0